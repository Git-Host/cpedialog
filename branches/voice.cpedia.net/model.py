...
class CPediaLog(SerializableModel):
    ...
    twitter_consumer_key = db.StringProperty(multiline=False,default='')
    twitter_consumer_secret = db.StringProperty(multiline=False,default='')
    twitter_request_token_key = db.StringProperty(multiline=False,default='')
    twitter_request_token_secret = db.StringProperty(multiline=False,default='')
    twitter_access_key = db.StringProperty(multiline=False,default='')
    twitter_access_secret = db.StringProperty(multiline=False,default='')
