...
from sinat.binder import bind_api
from sinat.error import TweepError
from sinat.parsers import ModelParser
...
class API(object):
    ...
    comments_timeline = bind_api(
        ...
        payload_type = 'comment', payload_list = True,
        allowed_param = ['since_id', 'max_id', 'count', 'page'],
        require_auth = True
    )
    ...
    counts = bind_api(
        ...
        payload_type = 'count', payload_list = True,
        allowed_param = ['ids'],
        require_auth = True
    )
    ...
    friends = bind_api(
        ...
        payload_type = 'users_list',
        allowed_param = ['id', 'user_id', 'screen_name', 'count', 'cursor']
    )
